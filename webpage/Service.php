...
<body>
  ...
  <div class="container mt-5">
    ...
    <div class="col-md-4 mb-4">
        <div class="card">
          <img src="../css/image/service4.jpg" class="card-img-top" alt="Service 2 Image">
          <div class="card-body">
            <h5 class="card-title">Service 2</h5>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vel ligula vitae lorem tristique sollicitudin.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-4">
        <div class="card">
          <img src="../css/image/service2.jpg" class="card-img-top" alt="Service 2 Image">
          <div class="card-body">
            <h5 class="card-title">Service 2</h5>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vel ligula vitae lorem tristique sollicitudin.</p>
          </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          <img src="../css/image/service3.jpg" class="card-img-top" alt="Service 3 Image">
          <div class="card-body">
  ...
  <div class="col-md-4 mb-4">
        <div class="card">
          <img src="../css/image/service5.jpg" class="card-img-top" alt="Service 2 Image">
          <div class="card-body">
            <h5 class="card-title">Service 2</h5>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vel ligula vitae lorem tristique sollicitudin.</p>
          </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          <img src="../css/image/service8.jpg" class="card-img-top" alt="Service 2 Image">
          <div class="card-body">
            <h5 class="card-title">Service 2</h5>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vel ligula vitae lorem tristique sollicitudin.</p>
          </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          <img src="../css/image/service7.jpg" class="card-img-top" alt="Service 3 Image">
          <div class="card-body">
            <h5 class="card-title">Service 3</h5>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vel ligula vitae lorem tristique sollicitudin.</p>
          </div>
